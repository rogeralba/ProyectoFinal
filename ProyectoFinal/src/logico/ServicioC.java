...
public ServicioC(String codigo,String nombre, String apellido, String apellido2, String cedula, String direccion, String telefono, String notamedia,
		float salario, String contrase, String nacim, String sexo) {
	super(codigo,nombre, apellido,apellido2, cedula, direccion, telefono, notamedia, salario, contrase,nacim,sexo);
...
public ArrayList<Plan> getMisVentas() {
	return misVentas;
}
public void setMisVentas(ArrayList<Plan> misVentas) {
